...
function renderTable@Entity@(condition)
 {
	...
	var aurl = uelede + "../../Control/@Entity@Control.ashx?action=FindList&pagesize=" + pagesize + "&page=" + currentpage;
	if(condition != null)
		aurl += condition;
	$.ajax({ 
        type: "get", 
 ...
 function del@Entity@(id)
 {
	 var urled = window.location.href;
		...
		var aurl = uelede + "../../Control/@Entity@Control.ashx?action=Delete&id=" + id;
		$.ajax({ 
	        type: "get", 
	        url: aurl, 
	        dataType: "jsonp", 
 ...
 function renderDiv@Entity@(location)
  {	 
 	...
 	var aurl = uelede + "../../Control/@Entity@Control.ashx?action=Find&id=" + id;
 	$.ajax({ 
         type: "get", 
         url: aurl, 
         dataType: "jsonp", 
 ...
 @chooseNameSetting@
         	...
         	var aurl = uelede + "../../Control/@Entity@Control.ashx?action=Save";
         	var id =UrlParm.parm("id");
         	if(id != null)
         		aurl += "?id=" + id;
